...
class HttpConnectInbound final : public IInbound,
                                 public std::enable_shared_from_this<HttpConnectInbound> {
public:
    HttpConnectInbound(asio::any_io_executor ex, config::InboundConfig cfg)
